...
function Dashboard() {
    ...
    useEffect( () => {
        ...
        async function getPopularVideos(){
            await fetch("https://youtube.googleapis.com/youtube/v3/videos?part=snippet%2CcontentDetails%2Cstatistics&chart=mostPopular&regionCode=US&key=AIzaSyB_1mfqc2jVtISriLjNZSn987h27rdm2KU&maxResults=1").then(data => data.json())
